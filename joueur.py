...
class Joueur:
    ...
    def nb_a_tirer(self):
        ...
        return sum(x is None for x in self.chevalet)
    ...
    def position_est_valide(self, position):
        ...
        # TODO: À compléter
        # Mettre votre code ici
        return position < self.taille_chevalet
    ...
    def ajouter_jeton(self, jeton, position=None):
        ...
        nouveau_chevalet = []
        x = 0
        for position in range(len(self.chevalet)):
            if x == 0:
                if self.chevalet[position] is None:
                    nouveau_chevalet.append(jeton)
                    x = x + 1
                else:
                    nouveau_chevalet.append(self.chevalet[position])
            else:
                nouveau_chevalet.append(self.chevalet[position])
